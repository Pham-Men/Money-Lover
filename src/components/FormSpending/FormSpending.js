...
function FormSpending () {
    ...
    const formikSpending = useFormik({
        initialValues: {
            number: '',
            indWallet: ''
        },
                ...
                (
                    `${firestoreUrl}/${idWallet}`,
                    {
                        fields: {
                            ...
                            totalMoney: { 'integerValue': (parseInt(dataUserLocal[values.indWallet].fields.totalMoney.integerValue) + parseInt(values.number)) },
    ...
    return (
        <>
            <form onSubmit={formikSpending.handleSubmit}>
                <Box
                    sx={{
                        display: 'flex',
                        alignItems: 'end'
                ...
                >
                    ...
                    >
                        ...
                        <TextField
                            size='small'
                            onChange={formikSpending.handleChange}
                            value={formikSpending.values.number}
                            name='number'
                            color="success"
                            error={formikSpending.touched.number && Boolean(formikSpending.errors.number)}
                            helperText={formikSpending.touched.number && formikSpending.errors.number}
                            sx={{
                                width: '140px',
                                height: '40px',
                                '&:hover': {
                    ...
                    >
                        ...
                        <Select
                            ...
                            size='small'
                            value={formikSpending.values.indWallet}
                            name='indWallet'
                            onChange={formikSpending.handleChange}
                        >
